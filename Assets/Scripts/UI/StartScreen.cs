...
public class StartScreen : MonoBehaviour
{
    ...
    public TextMeshProUGUI currentScoreText;  // New text for current score
    public TextMeshProUGUI statusMessageText;  // New text for status messages
    ...
    public void UpdateCurrentScoreDisplay()
    {
        if (currentScoreText != null)
        {
            ...
            Debug.Log($"[StartScreen] Updated current score display: {GameManager.Instance.score}");
        }
    }
    ...
    public void UpdateHighScoreDisplay()
    {
        if (highScoreText != null)
        {
            ...
            Debug.Log($"[StartScreen] Updated high score display: {GameManager.Instance.highScore}");
        }
    }
}